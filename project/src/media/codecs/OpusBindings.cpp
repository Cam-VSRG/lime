...
namespace lime {
	...
	HL_PRIM int HL_NAME(hl_opus_file_decode) (HL_CFFIPointer* opusFile, Bytes* buffer, int position, int length) {
	...
	DEFINE_HL_PRIM (_DYN,          hl_opus_file_decode,             _TCFFIPOINTER _TBYTES _I32 _I32);
	...
	DEFINE_HL_PRIM (_F64,          hl_opus_file_tell,               _TCFFIPOINTER);
	DEFINE_HL_PRIM (_F64,          hl_opus_file_total,              _TCFFIPOINTER);
