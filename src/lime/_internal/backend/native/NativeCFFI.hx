...
class NativeCFFI
{
	...
	private static var lime_audio_decoder_decode = new cpp.Callable<cpp.Object->cpp.Object->Int->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_audio_decoder_decode", "ooiiii", false));
	...
	private static var lime_audio_data_util_read_normalized = new cpp.Callable<cpp.Object->Int->Int->Float>(cpp.Prime._loadPrime("lime", "lime_audio_data_util_read_normalized", "oiid", false));
	private static var lime_audio_data_util_write_normalized = new cpp.Callable<cpp.Object->Int->Int->Float->cpp.Void>(cpp.Prime._loadPrime("lime", "lime_audio_data_util_write_normalized", "oiidv", false));
	private static var lime_audio_data_util_copy_audio_data = new cpp.Callable<cpp.Object->Int->Int->cpp.Object->Int->Int->Int->Int->cpp.Void>(cpp.Prime._loadPrime("lime", "lime_audio_data_util_copy_audio_data", "oiioiiiiv", false));
	...
	private static var lime_audio_data_util_read_normalized = CFFI.load("lime", "lime_audio_data_util_read_normalized", 3);
	private static var lime_audio_data_util_write_normalized = CFFI.load("lime", "lime_audio_data_util_write_normalized", 4);
	private static var lime_audio_data_util_copy_audio_data = CFFI.load("lime", "lime_audio_data_util_copy_audio_data", -1);
